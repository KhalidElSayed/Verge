...
- (id)initWithURLString:(NSString *)urlString userInfo:(NSDictionary *)userInfo request:(NSMutableURLRequest *)request completionHandler:(JBContainedURLConnectionCompletionHandler)handler {
